...
# combine the plots (without second axis)
combined_plot <- plot2 +
  geom_line(data = df_delta, aes(x = aspect, y = proportion, group = 1, color = "proportions_delta"), linetype = "dashed") +
  scale_y_continuous(limits = c(0, 1), breaks = seq(0, 1, 0.25), expand = expansion(mult = c(0, 0.1)))

# combine the plots (with second axis)
combined_plot_axis <- plot2 +
  geom_line(data = df_delta, aes(x = aspect, y = proportion, group = 1, color = "proportions_delta"), linetype = "dashed") +
  scale_y_continuous(name = "Proporition",limits = c(0, 1), sec.axis = sec_axis(~., name = "Delta", breaks = seq(0, 0.5, 0.1), labels = paste0(seq(0, 0.5, 0.1)))) +
