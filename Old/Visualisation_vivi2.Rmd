...
plot2 <- df_prop %>%
  ...
  ggplot() +
  geom_segment(aes(y= aspect , x = economy,yend = aspect , xend = business)) +
  geom_point(mapping = aes(y = aspect, x = economy), size = 3) +
  geom_point(mapping = aes(y = aspect, x = business),size = 3) +
